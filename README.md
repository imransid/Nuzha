...
docker exec 33e0094e4b54 npx prisma generate --schema=./prisma/schema-user.prisma
docker exec 33e0094e4b54 npx prisma db push --force-reset --schema=./prisma/schema-user.prisma
