...
docker exec aed5127f6d83 npx prisma generate --schema=./prisma/schema-page-builder.prisma
docker exec aed5127f6d83 npx prisma db push --force-reset --schema=./prisma/schema-page-builder.prisma
