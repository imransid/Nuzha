...
docker exec a78282274a59 npx prisma generate --schema=./prisma/schema-user.prisma
docker exec a78282274a59 npx prisma db push --force-reset --schema=./prisma/schema-user.prisma
