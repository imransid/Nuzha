...
docker exec 07ceca4f7554 npx prisma generate --schema=./prisma/schema-page-builder.prisma
docker exec 5f8981dba94f npx prisma migrate deploy --schema=./prisma/schema-user.prisma
docker exec 984e024d8a8d npx prisma generate --schema=./prisma/schema-user.prisma
docker exec 984e024d8a8d npx prisma db push --force-reset --schema=./prisma/schema-user.prisma
docker exec 07ceca4f7554 npx prisma db push --force-reset --schema=./prisma/schema-page-builder.prisma
