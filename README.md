...
docker exec afcd82b7f75b npx prisma generate --schema=./prisma/schema-user.prisma
docker exec afcd82b7f75b npx prisma db push --force-reset --schema=./prisma/schema-user.prisma
